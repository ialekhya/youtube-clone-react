...
//  It will execute the request and if it is successful, it dispatches the action returned by entity.success. If it fails, it dispatches the action returned by entity.failure.